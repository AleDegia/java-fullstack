 ...
 * Tuttavia, è importante notare che se due oggetti Scanner stanno leggendo
 * dalla stessa sorgente (come System.in), chiudere uno di questi oggetti
 * Scanner interromperà anche l'altro. Questo accade perché la chiusura di uno
 * Scanner chiuderà anche la sua sorgente di input se quella sorgente implementa
 * l'interfaccia Closeable. Poiché System.in è una sorgente di input Closeable,
 * chiudendo uno Scanner che legge da System.in, System.in sarà chiuso e quindi
 * non sarà più disponibile per la lettura da parte di altri oggetti Scanner.
 */